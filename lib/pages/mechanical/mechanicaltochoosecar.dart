            ...
            if (snapshot.hasData == false) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  String customerId= snapshot.data[index][FirebaseAuth.instance.currentUser!.uid];
                  return CardsCars(snapshot.data.docs[index]['carModel'],snapshot.data.docs[index]['image'],snapshot.data.docs[index]['carType'],snapshot.data.docs[index]['name'],(){
                  FirebaseFirestore.instance.collection('user').doc(currentID).collection('customers').add(<String,dynamic>{
                    ...
                    'carImage':snapshot.data.docs[index]['image'],
                    'carType':snapshot.data.docs[index]['carType'],
                    'customerName':snapshot.data.docs[index]['name'],
                  });
                  print('...............................');
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> MechHome()));
                });
                },
              );
            }
      ...
      drawer: Drawer(
        child:  SingleChildScrollView(
          child: Column(
            ...
            child: Button(Text('Next', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25),), 150,(){Navigator.push(context, MaterialPageRoute(builder: (context)=> MechHome()));}),
          ),*/